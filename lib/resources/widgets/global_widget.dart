...
import '../colors/dump_colors.dart';
import '../icons/dump_icons.dart';
...
setDumpAppBar(BuildContext context, String appBarTitle) {
 ...
 setDumpAppBarwithLogo(BuildContext context, String imagepath) {
  ...
  return AppBar(
    ...
    title: Image.asset('assets/images/dumplogo.png', height: _mediaquery.height*0.2, width: _mediaquery.width*0.3,),
    centerTitle: true,
    actions: [
      ...
      title:Row(
        children: [
          Padding(
            ...
            child: Container(width: _mediaquery.width*0.40, height: _mediaquery.height*0.09,
